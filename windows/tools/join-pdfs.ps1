...
function Find-PdfPython {
    ...
    throw 'Python 3.10+ with pypdf 6 is required. Install Python, then run: py -m pip install "pypdf>=6,<7". Or set TUKEVEJTSO_PDF_PYTHON to a Python executable with pypdf installed.'
}
